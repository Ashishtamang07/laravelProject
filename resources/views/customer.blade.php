        ...
        <form action="{{url('/')}}/customer" method="post">
            ...
            <div class="container">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="customerName" id="" class="form-control" placeholder="" aria-describedby="helpId">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="countryName" id="" class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">state name</label>
                    <input type="text" name="stateName" id="" class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                </div>
